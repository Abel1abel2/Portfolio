...
const Hero = () => {
  ...
  return (
    <>
    <div id='home' className='w-full md:bg-yellow-200 sm:bg-green-300 lg:bg-red-300  h-[100dvh]] py-3 px-5 z-0 '>
           ...
           <div className='fixed z-0 w-[50%] h-full '>
            ...
            <div className='  w-[90%] md:w-[60%] lg:w-[50%]  h-full ml-5 md:ml-7  sm:ml-10 '>
                ...
                <div className=' h-full '>
                    <div className='flex flex-col space-y-3   sm:px-[2%] mt-[25%] sm:mt-[10%] lg:mt-[5%] '>
                      
                              <div className='md:pl-[25%] sm:pl-[5%] pl-[18%]  md:px-[15%] mt-20 md:mt-18 sm:mt-30 '> 
                               
                                <h1 className='font-delta  sm:text-[28px] md:text-[32px] lg:text-[54px] text-[18px]  '>Full Stack</h1>
                              ...
                              <div className='md:mt-7 sm:mt-10 mt-15  md:px-[3%] sm:px-[5%] px-[20%]  ml-[6%] lg:ml-[10%] w-[100%]   sm:w-[93%] flex sm:space-x-5 justify-center space-x-3  items-center z-0    '>

...
const Group2 = ({data}) => {
  ...
  return (
    <div className=' flex flex-col items-center justify-between py-10 h-full'>
      <div className='card1 z-50  lg:px-5   px-1 sm:px-1 mt-[50px] sm:mt-[115px] md:mt-[50px] bg-white  w-[100%] rounded-[10px] h-[13%] sm:h-[10%] md:h-[7%] flex flex-col md:space-y-2'>
      ...
      <div className="card1 z-50 px-1 sm:px-1 lg:px-5   md:px-2 bg-white mt-[10px] md:mt-[250px] sm:mt-[80px] w-[100%] rounded-[10px] h-[13%] sm:h-[10%] md:h-[7%] flex flex-col space-y-2 ">

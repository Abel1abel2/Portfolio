...
const Group1 = ({data}) => {
  ...
  return (
    <div className='flex flex-col items-center justify-between py-10 h-full'>
      ...
      <div className='card2 z-50 bg-white px-1 sm:px-1 lg:px-5  md:mt-[100px] mt-[60px] sm:mt-[40px] lg:mt-0 md:px-2  w-[100%] rounded-[10px] sm:h-[10%] h-[13%] md:h-[7%] flex flex-col space-y-2 '>
      ...
      <div className='card2 z-50 bg-white  w-[100%] rounded-[10px] h-[13%] sm:h-[10%] md:h-[7%] md:mb-0 sm:mb-[70px] mb-[40px] flex flex-col space-y-2 lg:px-5 md:px-2 px-1 sm:px-1  '>
